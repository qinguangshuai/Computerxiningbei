...
public class RecordConfig implements Serializable {
    ...
    private int channelConfig1 = AudioFormat.CHANNEL_IN_STEREO;
     ...
     */
    public RecordConfig(RecordFormat format, int channelConfig1, int encodingConfig, int sampleRate) {
        this.format = format;
    ...
    public int getChannelCount() {
        if (channelConfig1 == AudioFormat.CHANNEL_IN_MONO) {
            return 1;
        } else if (channelConfig1 == AudioFormat.CHANNEL_IN_STEREO) {
            return 2;
        } else {
            return 0;
        }
    ...
    public RecordConfig setChannelConfig(int channelConfig1) {
        this.channelConfig1 = channelConfig1;
        return this;
    }
