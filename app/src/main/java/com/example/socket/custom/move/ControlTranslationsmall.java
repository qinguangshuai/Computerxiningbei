        ...
        switch (ratioOfGpsTrack) {
            case "1":
                ...
                if (mGpsPistanceCar <= 5) {
                    v.setX((float) (320 / 1.7 - transverse + mGpsPistanceCar / 1.7 * 12.8f));
                    v.setY((float) (450 / 1.7 + disparity  + 8 + mGpsPistanceCar / 1.7  * 10f));
                } else if (mGpsPistanceCar > 5 && mGpsPistanceCar <= 94) {
                    v.setX((float) (384 / 1.7 - transverse + (mGpsPistanceCar  - 5)/ 1.7 * 2.88f));
                    v.setY((float) (500 / 1.7 + disparity + 8));
                } else {
                    v.setX((float) (640 / 1.7 - transverse + (mGpsPistanceCar - 94) / 1.7 * 10.67f));
                    v.setY((float) (500 / 1.7 + disparity + 8 + (mGpsPistanceCar - 94) / 1.7 * 8.33f));
                }
                v.invalidate();
                break;
            case "2":
                ...
                if (mGpsPistanceCar <= 87) {
                    v.setX((float) (50 / 1.7 - transverse + mGpsPistanceCar / 1.7 * 8.25f));
                    v.setY((float) (450 / 1.7 + disparity + 8));
                } else {
                    v.setX((float) (768 / 1.7 - transverse + (mGpsPistanceCar - 87) / 1.7 * 4.92f));
                    v.setY((float) (450 / 1.7 + disparity + 8 + (mGpsPistanceCar - 87) / 1.7  * 3.84f));
                }
                v.invalidate();
                break;
            case "3":
                ...
                s3.setName("gone");*/
                s1.setName("zheng");
                v.setX((float) (128 / 1.7 - transverse + mGpsPistanceCar / 1.7 * 8.46f));
                v.setY((float) (400 / 1.7 + disparity + 8));
                v.invalidate();
                break;
            case "4":
                /*s1.setName("visible");
                ...
                if (mGpsPistanceCar <= 6) {
                    v.setX((float) (256 / 1.7 - transverse + mGpsPistanceCar / 1.7 * 10.67f));
                    v.setY((float) (400 / 1.7 + disparity + 8 - mGpsPistanceCar / 1.7 * 8.33f));
                } else if (mGpsPistanceCar > 6 && mGpsPistanceCar <= 94) {
                    v.setX((float) (320 / 1.7 - transverse + (mGpsPistanceCar - 6) / 1.7 * 4.36f));
                    v.setY((float) (350 / 1.7 + disparity + 8));
                } else {
                    v.setX((float) (704 / 1.7 - transverse + (mGpsPistanceCar - 94) / 1.7 * 10.67f));
                    v.setY((float) (350 / 1.7 + disparity + 8 + (mGpsPistanceCar - 94) / 1.7 * 8.33f));
                }
                v.invalidate();
                break;
            case "5":
                ...
                s1.setName("zheng");
                if (mGpsPistanceCar <= 6) {
                    v.setX((float) (320 / 1.7 - transverse + mGpsPistanceCar / 1.7 * 10.67f));
                    v.setY((float) (350 / 1.7 + disparity + 8 - mGpsPistanceCar / 1.7 * 8.33f));
                } else if (mGpsPistanceCar > 6 && mGpsPistanceCar <= 93) {
                    v.setX((float) (384 / 1.7 - transverse + (mGpsPistanceCar - 6) / 1.7 * 2.94f));
                    v.setY((float) (300 / 1.7 + disparity + 8));
                } else {
                    v.setX((float) (640 / 1.7 - transverse + (mGpsPistanceCar - 93) / 1.7 * 9.14f));
                    v.setY((float) (300 / 1.7 + disparity + 8 + (mGpsPistanceCar - 93) / 1.7 * 7.14f));
                }
                v.invalidate();
                break;
            case "6":
            ...
            case "7":
                ...
                if (mGpsPistanceCar <= 20) {
                    v.setX((float) (128 / 1.7 - transverse + mGpsPistanceCar / 1.7 * 3.84f));
                    v.setY((float) (250 / 1.7 + disparity  - mGpsPistanceCar / 1.7 * 5f));
