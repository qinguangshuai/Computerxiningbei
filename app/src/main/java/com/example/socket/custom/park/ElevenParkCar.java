...
public class ElevenParkCar extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        List<ParkDataUser> parkcar = dataDao.find("elevenParkcar");
        ...
        if (size > 1 && size % 2 == 0) {
            for (int i = 0; i < size; i += 2) {
                ...
                if (aDoubleRatioOfGpsPointCar <= 77 && aDoubleRatioOfGpsPointCar1 <= 77) {
                    canvas.drawLine((550 - (76 - aDoubleRatioOfGpsPointCar) * 6.58f), 300 - disparity, (550 - (76 - aDoubleRatioOfGpsPointCar1) * 6.58f), 300 - disparity, mPaint);
                } else if (aDoubleRatioOfGpsPointCar > 77 && aDoubleRatioOfGpsPointCar1 <= 77) {
                    canvas.drawLine((550 - (76 - 76) * 6.58f), 300 - disparity, (550 - (76 - aDoubleRatioOfGpsPointCar1) * 6.58f), 300 - disparity, mPaint);
                }else if (aDoubleRatioOfGpsPointCar <= 77 && aDoubleRatioOfGpsPointCar1 > 77) {
                    canvas.drawLine((550 - (76 - 76) * 6.58f), 300 - disparity, (550 - (76 - 76) * 6.58f), 300 - disparity, mPaint);
                }
            }
        }
    }
